      ...
      <section id="team">
        <div class="section-aboutus">
          <div class="about-card">
            ...
            <!-- <img
              class="photo-with-tape"
              srcset="
                imgs/Hania-480.jpg   480w,
                imgs/Hania-768.jpg   768w,
                imgs/Hania-1280.jpg 1280w
              "
              src="imgs/Hania-1280.jpg"
              sizes="(max-width: 600px) 480px, (max-width: 1280px) 768px, 1280px"
              alt="Female how is not Hania" /> -->
            <div>
              <h2>Meet Hania</h2>
              <p>
          ...
          <div class="about-card flex-reverse photo-to-right">
            <img
              class="photo-with-tape"
              src="imgs/Inga-480.jpg"
              srcset="
                imgs/Inga.jpg       480w,
                imgs/Inga-768.jpg   768w,
                imgs/Inga-1280.jpg 1280w
              "
              sizes="(max-width: 600px) 480px, (max-width: 1280px) 768px, 1280px"
              alt="Female how is not Inga" />
            <div>
          ...
          <div class="about-card">
            <img
              class="photo-with-tape"
              src="imgs/Agnieszka-480.jpg"
              srcset="
                imgs/Agnieszka-480.jpg   480w,
                imgs/Agnieszka-768.jpg   768w,
                imgs/Agnieszka-1280.jpg 1280w
              "
              sizes="(max-width: 600px) 480px, (max-width: 1280px) 768px, 1280px"
              alt="Female how is not Agnieszka" />
            <div>
